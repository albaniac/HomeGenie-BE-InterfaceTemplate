...
* Example would become the interface domain, and the class name the interface name
...
namespace MIG.Interfaces.$domain$.$safeprojectname$
{
    /// <summary>
    ...
    public class InterfaceSkelton : MigInterface
    {
        ...
        public bool Connect()
        {
            if (!this.IsConnected)
            {
                ...
                Log.Info("Starting {0}, Version {1}", this.GetDomain(),
                    Assembly.GetExecutingAssembly().GetName().Version.ToString());


                // TODO: If this option isn't in the configuration file then a terminating error will be thrown.
            ...
            // Sample Code Here....
            // Do not put blocking code here, consider:
            var task = new Task(new Action(WorkerTask));
            task.Start();
        ...
        protected virtual void OnInterfacePropertyChanged(string domain, string source, string description,
